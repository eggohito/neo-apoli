...
public enum TextureOverlayHudElementRenderer implements OverlayHudElementRenderer {
	...
	public void render(Context context, HudElement element, GuiGraphics graphics, DeltaTracker delta) {
		...
		if (!(element instanceof TextureOverlayHudElement textureOverlay) || !this.isVisibleInPerspective(context, textureOverlay)) {
			return;
		}
