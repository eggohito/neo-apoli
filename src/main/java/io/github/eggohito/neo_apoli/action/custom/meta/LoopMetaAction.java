...
public interface LoopMetaAction<A extends Action> extends Action {
	...
	static <A extends Action, M extends LoopMetaAction<A>> MapCodec<M> mapCodec(Codec<A> actionCodec, Function4<Optional<A>, Optional<A>, NumberProvider, A, M> constructor) {
	...
	static <A extends Action, M extends LoopMetaAction<A>> StreamCodec<RegistryFriendlyByteBuf, M> streamCodec(StreamCodec<RegistryFriendlyByteBuf, A> actionCodec, Function4<Optional<A>, Optional<A>, NumberProvider, A, M> constructor) {
