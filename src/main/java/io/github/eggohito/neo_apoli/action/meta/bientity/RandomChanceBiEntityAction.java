...
public record RandomChanceBiEntityAction(BiEntityAction successAction, Optional<BiEntityAction> failAction, float chance) implements BiEntityAction, RandomChanceMetaAction<BiEntityAction, BiEntityActionType<?>> {
	...
	public static final MapCodec<RandomChanceBiEntityAction> CODEC = NeoApoliCodecs.lazyMap(RandomChanceBiEntityAction.class.getSimpleName(), () -> RandomChanceMetaAction.codec(BiEntityAction.CODEC, RandomChanceBiEntityAction::new));
