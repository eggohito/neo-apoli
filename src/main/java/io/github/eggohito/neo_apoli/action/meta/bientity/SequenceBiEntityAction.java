...
public record SequenceBiEntityAction(List<BiEntityAction> actions) implements BiEntityAction, SequenceMetaAction<BiEntityAction, BiEntityActionType<?>> {
	...
	public static final MapCodec<SequenceBiEntityAction> CODEC = NeoApoliCodecs.lazyMap(SequenceBiEntityAction.class.getSimpleName(), () -> SequenceMetaAction.codec(BiEntityAction.CODEC, SequenceBiEntityAction::new));
