...
public record RandomChanceBlockAction(BlockAction successAction, Optional<BlockAction> failAction, float chance) implements BlockAction, RandomChanceMetaAction<BlockAction, BlockActionType<?>> {
	...
	public static final MapCodec<RandomChanceBlockAction> CODEC = RandomChanceMetaAction.createCodec(BlockAction.CODEC, RandomChanceBlockAction::new);
	public static final PacketCodec<RegistryByteBuf, RandomChanceBlockAction> PACKET_CODEC = RandomChanceMetaAction.createPacketCodec(BlockAction.PACKET_CODEC, RandomChanceBlockAction::new);
