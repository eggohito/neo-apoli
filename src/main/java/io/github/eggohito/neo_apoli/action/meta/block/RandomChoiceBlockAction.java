...
public final class RandomChoiceBlockAction extends BlockAction implements RandomChoiceMetaAction<BlockAction> {
	...
	public static final MapCodec<RandomChoiceBlockAction> CODEC = MapCodecUtil.lazy(RandomChoiceBlockAction.class.getSimpleName(), () -> RandomChoiceMetaAction.codec(BlockAction.CODEC, RandomChoiceBlockAction::new));
	public static final PacketCodec<RegistryByteBuf, RandomChoiceBlockAction> PACKET_CODEC = PacketCodecUtil.lazy(RandomChoiceBlockAction.class.getSimpleName(), () -> RandomChoiceMetaAction.packetCodec(BlockAction.PACKET_CODEC, RandomChoiceBlockAction::new));
