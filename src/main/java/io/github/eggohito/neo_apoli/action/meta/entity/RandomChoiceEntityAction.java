...
public record RandomChoiceEntityAction(WeightedList<EntityAction> actions) implements EntityAction, RandomChoiceMetaAction<EntityActionContext, EntityAction, EntityActionType<?>> {
