...
public record SequenceEntityAction(List<EntityAction> actions) implements EntityAction, SequenceMetaAction<EntityActionContext, EntityAction, EntityActionType<?>> {
