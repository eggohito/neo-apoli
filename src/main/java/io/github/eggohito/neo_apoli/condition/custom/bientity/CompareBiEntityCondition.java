...
public record CompareBiEntityCondition(Comparison comparison) implements BiEntityCondition, CompareMetaCondition {
	...
	public static final MapCodec<CompareBiEntityCondition> CODEC = CompareMetaCondition.createCodec(CompareBiEntityCondition::new);
	public static final StreamCodec<RegistryFriendlyByteBuf, CompareBiEntityCondition> STREAM_CODEC = CompareMetaCondition.createStreamCodec(CompareBiEntityCondition::new);
