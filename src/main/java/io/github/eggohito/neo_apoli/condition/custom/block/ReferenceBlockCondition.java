...
public record ReferenceBlockCondition(ResourceLocation value) implements BlockCondition, ReferenceMetaCondition<BlockCondition> {
	...
	public static final MapCodec<ReferenceBlockCondition> CODEC = ReferenceMetaCondition.createCodec(ReferenceBlockCondition::new);
	public static final StreamCodec<RegistryFriendlyByteBuf, ReferenceBlockCondition> STREAM_CODEC = ReferenceMetaCondition.createStreamCodec(ReferenceBlockCondition::new);
