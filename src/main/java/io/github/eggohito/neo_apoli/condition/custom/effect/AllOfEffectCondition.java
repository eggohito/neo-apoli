...
public record AllOfEffectCondition(List<EffectCondition> conditions) implements EffectCondition, AllOfMetaCondition<EffectCondition> {
	...
	public static final MapCodec<AllOfEffectCondition> CODEC = MapCodecUtil.lazy(AllOfEffectCondition.class.getSimpleName(), () -> AllOfMetaCondition.createCodec(EffectCondition.CODEC, AllOfEffectCondition::new));
	public static final StreamCodec<RegistryFriendlyByteBuf, AllOfEffectCondition> STREAM_CODEC = StreamCodecUtil.lazy(AllOfEffectCondition.class.getSimpleName(), () -> AllOfMetaCondition.createStreamCodec(EffectCondition.STREAM_CODEC, AllOfEffectCondition::new));
