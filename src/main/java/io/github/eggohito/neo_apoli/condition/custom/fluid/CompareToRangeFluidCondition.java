...
public record CompareToRangeFluidCondition(NumberProvider value, Optional<NumberProvider> min, Optional<NumberProvider> max) implements FluidCondition, CompareToRangeMetaCondition {
	...
	public static final MapCodec<CompareToRangeFluidCondition> CODEC = CompareToRangeMetaCondition.createCodec(CompareToRangeFluidCondition::new);
	public static final StreamCodec<RegistryFriendlyByteBuf, CompareToRangeFluidCondition> STREAM_CODEC = CompareToRangeMetaCondition.createStreamCodec(CompareToRangeFluidCondition::new);
