...
public record ConstantFluidCondition(boolean value) implements FluidCondition, ConstantMetaCondition {
	...
	public static final MapCodec<ConstantFluidCondition> CODEC = ConstantMetaCondition.createCodec(ConstantFluidCondition::new);

	public static final StreamCodec<RegistryFriendlyByteBuf, ConstantFluidCondition> STREAM_CODEC = ConstantMetaCondition.createStreamCodec(ConstantFluidCondition::new);
