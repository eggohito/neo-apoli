...
public record InvertedFluidCondition(FluidCondition condition) implements FluidCondition, InvertedMetaCondition<FluidCondition> {
	...
	public static final MapCodec<InvertedFluidCondition> CODEC = MapCodecUtil.lazy(InvertedFluidCondition.class.getSimpleName(), () -> InvertedMetaCondition.createCodec(FluidCondition.CODEC, InvertedFluidCondition::new));
	public static final StreamCodec<RegistryFriendlyByteBuf, InvertedFluidCondition> STREAM_CODEC = StreamCodecUtil.lazy(InvertedFluidCondition.class.getSimpleName(), () -> InvertedMetaCondition.createStreamCodec(FluidCondition.STREAM_CODEC, InvertedFluidCondition::new));
