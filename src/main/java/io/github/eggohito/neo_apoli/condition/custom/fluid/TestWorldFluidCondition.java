...
public record TestWorldFluidCondition(WorldCondition condition) implements FluidCondition, TestWorldMetaCondition {
	...
	public static final MapCodec<TestWorldFluidCondition> CODEC = TestWorldMetaCondition.createCodec(TestWorldFluidCondition::new);
	public static final StreamCodec<RegistryFriendlyByteBuf, TestWorldFluidCondition> STREAM_CODEC = TestWorldMetaCondition.createStreamCodec(TestWorldFluidCondition::new);
