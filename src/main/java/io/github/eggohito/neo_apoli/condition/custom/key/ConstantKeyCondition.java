...
public record ConstantKeyCondition(boolean value) implements KeyCondition, ConstantMetaCondition {
	...
	public static final MapCodec<ConstantKeyCondition> CODEC = ConstantMetaCondition.createCodec(ConstantKeyCondition::new);

	public static final StreamCodec<RegistryFriendlyByteBuf, ConstantKeyCondition> STREAM_CODEC = ConstantMetaCondition.createStreamCodec(ConstantKeyCondition::new);
