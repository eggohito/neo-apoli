...
public record InvertedKeyCondition(KeyCondition condition) implements KeyCondition, InvertedMetaCondition<KeyCondition> {
	...
	public static final MapCodec<InvertedKeyCondition> MAP_CODEC = MapCodecUtil.lazy(InvertedKeyCondition.class.getSimpleName(), () -> InvertedMetaCondition.mapCodec(KeyCondition.CODEC, InvertedKeyCondition::new));
	public static final StreamCodec<RegistryFriendlyByteBuf, InvertedKeyCondition> STREAM_CODEC = StreamCodecUtil.lazy(InvertedKeyCondition.class.getSimpleName(), () -> InvertedMetaCondition.streamCodec(KeyCondition.STREAM_CODEC, InvertedKeyCondition::new));
