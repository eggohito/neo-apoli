...
public record TestWorldKeyCondition(WorldCondition condition) implements KeyCondition, TestWorldMetaCondition {
	...
	public static final MapCodec<TestWorldKeyCondition> MAP_CODEC = TestWorldMetaCondition.mapCodec(TestWorldKeyCondition::new);
	public static final StreamCodec<RegistryFriendlyByteBuf, TestWorldKeyCondition> STREAM_CODEC = TestWorldMetaCondition.streamCodec(TestWorldKeyCondition::new);
