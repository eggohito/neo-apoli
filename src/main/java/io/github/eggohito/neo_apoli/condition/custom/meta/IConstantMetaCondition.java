...
public interface IConstantMetaCondition extends MetaCondition {
	...
	static <M extends IConstantMetaCondition> MapCodec<M> mapCodec(BooleanFunction<M> constructor) {
		return RecordCodecBuilder.mapCodec(instance -> instance.group(
			Codec.BOOL.fieldOf("value").forGetter(IConstantMetaCondition::value)
		).apply(instance, constructor::apply));
	}

	static <M extends IConstantMetaCondition> StreamCodec<RegistryFriendlyByteBuf, M> streamCodec(BooleanFunction<M> constructor) {
