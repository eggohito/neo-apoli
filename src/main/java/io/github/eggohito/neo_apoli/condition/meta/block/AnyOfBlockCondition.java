...
public record AnyOfBlockCondition(List<BlockCondition> conditions) implements BlockCondition, AnyOfMetaCondition<BlockCondition, BlockConditionType<?>> {
	...
	public static final MapCodec<AnyOfBlockCondition> CODEC = MultiMetaCondition.createCodec(BlockCondition.CODEC, AnyOfBlockCondition::new);
	public static final PacketCodec<RegistryByteBuf, AnyOfBlockCondition> PACKET_CODEC = MultiMetaCondition.createPacketCodec(BlockCondition.PACKET_CODEC, AnyOfBlockCondition::new);
