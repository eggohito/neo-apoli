...
public class BiEntityConditionTypes extends ConditionTypes {
	...
	public static final BiEntityConditionType<TestEntityBiEntityCondition> TEST_ENTITY = registerMetaInternal("test_entity", TestEntityBiEntityCondition.CODEC, TestEntityBiEntityCondition.STREAM_CODEC);
	public static final BiEntityConditionType<TestWorldBiEntityCondition> TEST_WORLD = registerMetaInternal("test_world", TestWorldBiEntityCondition.CODEC, TestWorldBiEntityCondition.STREAM_CODEC);
