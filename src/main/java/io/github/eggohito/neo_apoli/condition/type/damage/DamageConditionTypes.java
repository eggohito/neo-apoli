...
public class DamageConditionTypes extends ConditionTypes {
	...
	private static <C extends DamageCondition> DamageConditionType<C> registerInternal(String path, MapCodec<C> mapCodec, StreamCodec<RegistryFriendlyByteBuf, C> packetCodec) {
		return register(NeoApoli.id(path), mapCodec, packetCodec);
	}

	public static <C extends DamageCondition> DamageConditionType<C> register(ResourceLocation id, MapCodec<C> mapCodec, StreamCodec<RegistryFriendlyByteBuf, C> packetCodec) {
		return register(id.withPrefix(DamageConditionType.PREFIX), Registry.register(NeoApoliRegistries.DAMAGE_CONDITION_TYPE, id, new DamageConditionType<>(mapCodec, packetCodec)));
	}
