package io.github.eggohito.neo_apoli.mixin.impl.action.custom.explode;

import com.llamalad7.mixinextras.injector.wrapoperation.Operation;
import com.llamalad7.mixinextras.injector.wrapoperation.WrapOperation;
import io.github.eggohito.neo_apoli.action.custom.ExplodeAction;
...
public abstract class ServerExplosionMixin implements Explosion {
	...
	private List<Entity> getAllEntitiesIncludingSelf(ServerLevel serverWorld, Entity entity, AABB box, Operation<List<Entity>> original) {
		...
		if (this.damageCalculator instanceof ExplodeAction.DamageCalculator) {
