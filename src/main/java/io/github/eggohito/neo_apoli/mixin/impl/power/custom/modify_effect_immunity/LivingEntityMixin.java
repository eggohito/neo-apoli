package io.github.eggohito.neo_apoli.mixin.impl.power.custom.modify_effect_immunity;
...
public abstract class LivingEntityMixin extends Entity implements Attackable {
	...
	boolean immunityOnApply(boolean original, MobEffectInstance effectInstance, @Nullable Entity applier) {
	...
	boolean immunityOnTick(boolean original, @Local MobEffectInstance effectInstance) {
