...
public class PowerTypes {
	...
	public static final PowerType<BlockBreakPower> BLOCK_BREAK = registerInternal("block_break", MiscUtil.mergeContextTypes(ContextTypes.GENERIC, ContextTypes.BLOCK), BlockBreakPower.CODEC, BlockBreakPower.PACKET_CODEC);
	public static final PowerType<BlockHarvestPower> BLOCK_HARVEST = registerInternal("block_harvest", MiscUtil.mergeContextTypes(ContextTypes.GENERIC, ContextTypes.BLOCK), BlockHarvestPower.CODEC, BlockHarvestPower.PACKET_CODEC);
	public static final PowerType<BlockInteractPower> BLOCK_INTERACT = registerInternal("block_interact", MiscUtil.mergeContextTypes(ContextTypes.GENERIC, ContextTypes.BLOCK, ContextTypes.ITEM), BlockInteractPower.CODEC, BlockInteractPower.PACKET_CODEC);
