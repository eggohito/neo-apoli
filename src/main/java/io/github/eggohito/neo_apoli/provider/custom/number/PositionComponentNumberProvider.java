...
public record PositionComponentNumberProvider(Vec3Provider position, Direction.Axis axis) implements NumberProvider {

	public static final MapCodec<PositionComponentNumberProvider> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
		Vec3Provider.CODEC.fieldOf("position").forGetter(PositionComponentNumberProvider::position),
	...
	public static final StreamCodec<RegistryFriendlyByteBuf, PositionComponentNumberProvider> STREAM_CODEC = StreamCodec.composite(
		Vec3Provider.STREAM_CODEC, PositionComponentNumberProvider::position,
