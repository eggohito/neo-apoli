...
public record UniformNumberProvider(NumberProvider min, NumberProvider max, Random random) implements NumberProvider {
	...
	public static final MapCodec<UniformNumberProvider> CODEC = NeoApoliCodecs.lazyMap("UniformNumberProvider", () -> RecordCodecBuilder.mapCodec(instance -> instance.group(
	...
	public static final PacketCodec<RegistryByteBuf, UniformNumberProvider> PACKET_CODEC = NeoApoliPacketCodecs.lazy("UniformNumberProvider", () -> PacketCodec.tuple(
