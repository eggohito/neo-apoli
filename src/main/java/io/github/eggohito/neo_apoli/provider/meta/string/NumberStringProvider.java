...
public final class NumberStringProvider extends StringProvider {
	...
	public static final MapCodec<NumberStringProvider> CODEC = MapCodecUtil.lazy(NumberStringProvider.class.getSimpleName(), () -> RecordCodecBuilder.mapCodec(instance -> instance.group(
	...
	public static final PacketCodec<RegistryByteBuf, NumberStringProvider> PACKET_CODEC = PacketCodecUtil.lazy(NumberStringProvider.class.getSimpleName(), () -> PacketCodec.tuple(
