...
public final class StringProviderTypes {
	...
	public static final StringProvider.Type<StorageStringProvider> STORAGE = registerInternal("storage", StorageStringProvider.CODEC, StorageStringProvider.PACKET_CODEC);
