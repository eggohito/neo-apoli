...
public class NeoApoliPowerTypes {
	...
	private static <P extends Power> Power.Type<P> registerInternal(String path, MapCodec<P> mapCodec, StreamCodec<RegistryFriendlyByteBuf, P> streamCodec, UnaryOperator<ContextKeySet.Builder> builderBuilder) {
		return register(NeoApoli.id(path), mapCodec, streamCodec, builderBuilder);
	}

	public static <P extends Power> Power.Type<P> register(ResourceLocation id, MapCodec<P> mapCodec, StreamCodec<RegistryFriendlyByteBuf, P> streamCodec, UnaryOperator<ContextKeySet.Builder> builderBuilder) {
		...
		return Registry.register(NeoApoliRegistries.POWER_TYPE, id, new Power.Type<>(keySet, mapCodec, streamCodec));
