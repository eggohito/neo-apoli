...
public class NeoApoliRegistryKeys {
	...
	public static final RegistryKey<Registry<io.github.eggohito.neo_apoli.condition.type.entity.EntityConditionType<?>>> ENTITY_CONDITION_TYPE = create("entity_condition_type");
