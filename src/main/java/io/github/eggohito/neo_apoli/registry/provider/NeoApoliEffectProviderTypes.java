...
import io.github.eggohito.neo_apoli.provider.custom.effect.SwitchEffectProvider;
...
public final class NeoApoliEffectProviderTypes {
	...
	public static final EffectProvider.Type<SwitchEffectProvider> SWITCH = registerInternal("switch", SwitchEffectProvider.CODEC, SwitchEffectProvider.STREAM_CODEC);
