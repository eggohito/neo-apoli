...
public enum BlockUsePhase implements StringIdentifiable {
...
//	ITEM_ON_BLOCK("item_on_block");
	...
	public static final PacketCodec<ByteBuf, BlockUsePhase> PACKET_CODEC = PacketCodecUtil.enumType(BlockUsePhase.class);

	public static final Codec<EnumSet<BlockUsePhase>> SET_CODEC = CODEC.listOf().xmap(EnumSet::copyOf, ObjectArrayList::new);
	public static final PacketCodec<ByteBuf, EnumSet<BlockUsePhase>> SET_PACKET_CODEC = PacketCodecs.collection(ObjectArrayList::new, PACKET_CODEC).xmap(EnumSet::copyOf, ObjectArrayList::new);
