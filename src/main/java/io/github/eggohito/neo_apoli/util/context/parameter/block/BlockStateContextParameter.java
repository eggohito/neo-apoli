...
public class BlockStateContextParameter extends TypedContextParameter<BlockState> {

	public BlockStateContextParameter(Identifier id) {
	...
	public @Nullable CommandBuilder getCommandBuilder() {
		return new CommandBuilder() {
			...
			ServerCommandSource redirect(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
				...
				BlockState blockEntity = source.getWorld().getBlockState(blockPos);
				((ServerContextBuilderHolder) source).neo_apoli$getBuilder().add(BlockStateContextParameter.this, blockEntity);
